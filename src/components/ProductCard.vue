...
<template>
  <div
    class="product-card bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 group"
  >
    <!-- Product Image -->
    <div class="relative overflow-hidden">
      ...
      >
        <button
          class="bg-white p-2 rounded-full shadow-lg hover:bg-gray-50 transition-colors duration-200 mb-2 block"
        >
        ...
        <button
          class="bg-white p-2 rounded-full shadow-lg hover:bg-gray-50 transition-colors duration-200"
        >
          <svg class="w-5 h-5 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path
              stroke-linecap="round"
    ...
    <div class="p-6">
      ...
      <div class="flex items-center mb-3">
        <div class="flex items-center">
          <svg
            v-for="star in starArray.fullStars"
            :key="`full-${star}`"
